export const eData = [
  ...
  },
  {
    ...
    description: [
      "- Used Wordpress and React to create Wordpress Website from scratch",
      "- Used PHP and Wordpress API to make communications with the Wordpress database",
      "- Used UI/UX best practices to create Responsive and user-friendly websites",
      "- Made communications possible between Front end and backend using REST APIs ",
    ],
    type: "Full-time",
    startDate: "06/2022 ",
    endDate: "Present",
