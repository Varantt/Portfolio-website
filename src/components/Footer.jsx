...
export default function () {
  return (
    <div
      id="footer"
      className="flex flex-col space-y-4 p-6   text-white justify-between border-t-2 border-black bg-black   "
    >
      <div className="footer-container overflow-x-hidden 2xl:max-w-[1500px] xl:max-w-[1230px] md:max-w-none md:p-8  p-4 sm:p-4 m-auto w-full gap-8 md:gap-0 flex flex-col md:flex-row justify-between items-start">
        <div className="flex flex-col gap-4  items-center md:items-start  md:pl-10 w-full md:w-1/3  ">
      ...
      <div className="flex  justify-end overflow-x-hidden 2xl:max-w-[1500px] xl:max-w-[1230px] md:max-w-none md:p-8  p-4 sm:p-4 m-auto w-full  items-center">
